...
CREATE TABLE `ninjas` (
  ...
  `nja_name` varchar(30) NOT NULL,
  `nja_class` varchar(30) NOT NULL,
  `nja_team_id` int(11) NOT NULL,
  PRIMARY KEY (`nja_id`),
  KEY `nja_team_id` (`nja_team_id`),
  CONSTRAINT `ninjas_ibfk_1` FOREIGN KEY (`nja_team_id`) REFERENCES `teams` (`tea_id`)
...
-- Dump completed on 2020-11-16 18:55:37
